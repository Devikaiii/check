...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('This Movie Not Found In DataBase... Please check entered spelling 😝 Or else movie is not released on OTT platform. Ask here @raixpiro_bot ')
