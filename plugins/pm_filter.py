...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit('I cant find {query} in my database... Please check entered spelling 😝 Or else movie is not released on OTT platform. Ask here @raixpiro_bot ')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🔍 Movies&Series', url='https://t.me/BlasterMovieszz'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    if settings["button"]:
        btn = [
            [
                InlineKeyboardButton(
                    text=f"[{get_size(file.file_size)}]-📂-{file.file_name}{file.file_name}", callback_data=f'{pre}#{file.file_id}'
                ),
            ]
            for file in files
        ]
    ...
    if imdb:
        ...
        cap = f"Here is what i found for your query {query} Powered by [『ᴘɪʀᴏ』](https://t.me/raixpiro_bot)"
